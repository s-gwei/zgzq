...
//	private MqttMessageUtil mqttMessageUtil;
	...
	@Test
	public void mqtt() throws Exception {
		System.out.println(("----- selectAll method test ------"));
//		Result<Object> messageByTableName = mqttMessageUtil.findMessageByTableName("iotgateway/first", 1);
//		System.out.println(messageByTableName);
	}
