...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/HomeTable/**", "anon");
        ...
        //mqtt测试
        filterChainDefinitionMap.put("/mqttMessage/**", "anon");
        //influxdb测试
        filterChainDefinitionMap.put("/influxdb/**", "anon");
        //influxdb列查询
        filterChainDefinitionMap.put("/influxDBMessage/**", "anon");
        //tableMessage
        filterChainDefinitionMap.put("/tableMessage/**", "anon");
        //streamModel
        filterChainDefinitionMap.put("/streamModel/**", "anon");
        //valueStreamModel
        filterChainDefinitionMap.put("/valueStreamModel/**", "anon");
        //钉钉考勤
        filterChainDefinitionMap.put("/dingding/**", "anon");
        //上海考勤
        filterChainDefinitionMap.put("/attendanceTransit/**", "anon");
