...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements ISysRoleService {
    ...
    public IPage<SysRole> getRoleByDepartId(Page<SysRole> page, String departId, String roleName) {
        return sysRoleMapper.getRoleByDepartId(page,departId,roleName);
    }

    @Override
    public List<SysRole> getRoleByDepart(SysDepart depart) {
        String departId = depart.getId();
        return sysRoleMapper.getRoleByDepart(departId);
    }

    @Override
    public IPage<SysRoleSysDepartModel> queryUserByOrgCode(String orgCode, SysRole roleParams, IPage page) {
        List<SysRoleSysDepartModel> list = baseMapper.getRoleByOrgCode(page, orgCode, roleParams);
        Integer total = baseMapper.getRoleByOrgCodeTotal(orgCode, roleParams);

        IPage<SysRoleSysDepartModel> result = new Page<>(page.getCurrent(), page.getSize(), total);
    ...
    @Override
    public List<SysRole> getRoleByName(String username) {
        return sysRoleMapper.getRoleByName(username);
    }
}
