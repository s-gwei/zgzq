...
<script>
  import GlobalLayout from '@/components/heaveyPage/NewGlobalLayout'
  import Contextmenu from '@/components/menu/Contextmenu'
  import { mixin, mixinDevice } from '@/utils/mixin.js'
  import { triggerWindowResizeEvent } from '@/utils/util'
  const indexKey = '/report/projectRisk'
  console.log(location.hr);
  ...
  export default {
    ...
    methods: {
      ...
      dynamicRouterShow(key,title){
        console.log(key,title,this.linkList);
