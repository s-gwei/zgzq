...
public class DySmsHelper {
    ...
    static  String accessKeyId = "LTAI4FeKmqE9h1CwXmQMMc59";
    static  String accessKeySecret ="oOmmpB4tkhqbmgZM5z4CT2qJC7sXfB";
    ...
    public static void main(String[] args) throws ClientException, InterruptedException {
    	...
    	obj.put("code", "1234");
    	sendSms("15271947844", obj, DySmsEnum.FORGET_PASSWORD_TEMPLATE_CODE);
