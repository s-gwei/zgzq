...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" 创新工厂 发送消息任务 SendMsgJob !  开始时间:" + DateUtils.getTimestamp()));
		...
		log.info(" 创新工厂 发送消息任务 SendMsgJob !  消息数量:" + sysMessages.size());
		log.debug(sysMessages.toString());
		// 2.根据不同的类型走不通的发送实现类
