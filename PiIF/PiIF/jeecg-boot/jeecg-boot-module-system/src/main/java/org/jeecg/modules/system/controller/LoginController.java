...
public class LoginController {
    ...
    private static final String DEPART = "everyone";
    ...
    private Result<JSONObject> userInfo(SysUser sysUser, Result<JSONObject> result) {
        ...
        //过滤 everyone  部门
        departs = departs.stream().filter(e -> !DEPART.equals(e.getDepartName())).collect(Collectors.toList());
