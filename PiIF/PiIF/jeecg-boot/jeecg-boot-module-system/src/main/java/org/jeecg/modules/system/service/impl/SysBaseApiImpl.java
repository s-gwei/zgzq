...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	public LoginUser getUserByName(String username) {
		...
		org.jeecg.modules.system.entity.SysUser sysUser = userMapper.getUserByName(username);
		if(sysUser==null) {
			return null;
		}
	 ...
	 */
	@Override
	public LoginUser getUserByRealname(String realname) {
		if(oConvertUtils.isEmpty(realname)) {
			return null;
		}
		LoginUser loginUser = new LoginUser();
		List<SysUser> sysUserList = userMapper.selectList(new QueryWrapper<SysUser>().eq("realname", realname));
		if(sysUserList==null) {
			return null;
		}
	...
	public LoginUser getUserById(String id) {
		...
		LoginUser loginUser = new LoginUser();
		org.jeecg.modules.system.entity.SysUser sysUser = userMapper.selectById(id);
		if(sysUser==null) {
			return null;
		}
		BeanUtils.copyProperties(sysUser, loginUser);
	...
	public List<String> getDepartIdsByUsername(String username) {
		List<org.jeecg.modules.system.entity.SysDepart> list = sysDepartService.queryDepartsByUsername(username);
		List<String> result = new ArrayList<>(list.size());
		for (org.jeecg.modules.system.entity.SysDepart depart : list) {
	...
	public void sendSysAnnouncement(String fromUser, String toUser, String title, String msgContent, String setMsgCategory) {
		...
		for(int i=0;i<userIds.length;i++) {
			if(oConvertUtils.isNotEmpty(userIds[i])) {
				org.jeecg.modules.system.entity.SysUser sysUser = userMapper.getUserByName(userIds[i]);
				if(sysUser==null) {
					continue;
				}
	...
	public List<ComboModel> queryAllUser() {
		...
		List<org.jeecg.modules.system.entity.SysUser> userList = userMapper.selectList(new QueryWrapper<org.jeecg.modules.system.entity.SysUser>().eq("status","1").eq("del_flag","0"));
		for(org.jeecg.modules.system.entity.SysUser user : userList){
	...
	public List<ComboModel> queryAllRole() {
		List<ComboModel> list = new ArrayList<ComboModel>();
		List<org.jeecg.modules.system.entity.SysRole> roleList = roleMapper.selectList(new QueryWrapper<org.jeecg.modules.system.entity.SysRole>());
		for(org.jeecg.modules.system.entity.SysRole role : roleList){
			ComboModel model = new ComboModel();
	...
	public DictModel getParentDepartId(String departId) {
		org.jeecg.modules.system.entity.SysDepart depart = departMapper.getParentDepartId(departId);
	...
	public List<SysDepartModel> getAllSysDepart() {
		...
		List<org.jeecg.modules.system.entity.SysDepart> departList = departMapper.selectList(new QueryWrapper<org.jeecg.modules.system.entity.SysDepart>().eq("del_flag","0"));
