...
public class DataFormatter {
    ...
    public static Map<String, Object> formatData(String message) {
        ...
        List<ReceiveMessage> ReceiveMessageList = new ArrayList<>();
        //存入influxDB的数据,tags map
        TreeMap<String, Object> treeMap = new TreeMap<>();
        //key是timestamp  value是相同timestamp的消息
        Map<Long, List<ReceiveMessage>> map = new HashMap<>(16);
        //从jsonArray转成自己定义的集合
        ...
        for (ReceiveMessage receiveMessage1 : ReceiveMessageList) {
